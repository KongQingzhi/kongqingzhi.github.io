  ...
  <section class="py-10">
    ...
    <div class="mt-8">
      <div class="relative h-[650px] overflow-hidden rounded-lg border-2">
        ...
        <div
          class="w-[400px] flex justify-center items-center h-[80vh] absolute right-0 p-10 backdrop-blur-md"
        >
          <div>
...
const swiperList = [
  {
    ...
    date: '2025-03-13',
    title: '万象集',
    url: 'src/pages/gallery/DSC_2162.JPG',
  },
  {
    describe: '乱点碎红山杏发，平铺新绿水蘋生 — 白居易《南湖早春》',
    date: '2025-03-13',
    title: '芳华',
    url: 'src/pages/gallery/DSC_1468.jpg',
  },
  {
    describe: '晓声隆隆催转日，暮声隆隆催月出 — 李贺《官街鼓》',
    date: '2025-03-13',
    title: '凝固的诗篇',
    url: 'src/pages/gallery/DSC_0283.jpg',
  },
  {
    describe: '海上涛头一线来，楼前指顾雪成堆 — 苏轼《望海楼晚景》',
    date: '2025-03-13',
    title: '潮声录',
    url: 'src/pages/gallery/DSC_2201.jpg',
  },
  {
    describe: '长风破浪会有时，直挂云帆济沧海 — 李白《行路难》',
    date: '2025-03-13',
    title: '云帆志',
    url: 'src/pages/gallery/DSC_2209.jpg',
  },
  {
    describe: '万物静观皆自得，四时佳兴与人同 — 程颢《秋日偶成》',
    date: '2025-03-13',
